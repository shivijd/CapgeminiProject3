...
public interface WalletService {
        ...
        public Customer depositAmount(int id,String mobileNo,BigDecimal Amount);
        public Customer withdrawAmount(int id,String mobileNo,BigDecimal Amount) throws InvalidAmountPresentException;
